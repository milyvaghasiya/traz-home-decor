  ...
  return (
    <div className="max-w-[1050px] lg:px-10 md:px-6 px-4 mx-auto sm:py-20 py-12.5">
      ...
      <p className="mb-4">
        ...
        tincidunt vel, laoreet nec erat. Aliquam erat volutpat. Donec tincidunt
        magna dui, sit amet faucibus tortor dignissim ut. Nulla eget urna et
        nisl facilisis elementum nec ac ex. Phasellus quis hendrerit nibh, vitae
        sagittis ligula. Phasellus ante libero, varius quis felis sit amet,
        luctus bibendum nisl. Ut erat mi, bibendum id nibh sed, rutrum mollis
        dolor. Vivamus aliquet laoreet enim quis lobortis. Maecenas laoreet
        faucibus justo nec placerat. Sed finibus risus quis nisl pulvinar,
        gravida aliquet turpis vehicula. Morbi et arcu quis quam rhoncus congue
        eu vitae velit. Phasellus tristique mauris eget magna ullamcorper
        vulputate. Integer consequat fermentum ipsum. Duis mi lectus, elementum
        id tellus sed, sodales scelerisque eros.
      </p>
      <p>
        Nulla facilisi. Quisque laoreet mi non ipsum tempor condimentum. Nullam
        elit metus, rhoncus eu viverra ac, posuere at mi. Nulla facilisi.
        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
        cubilia curae; Cras consectetur ipsum a viverra tincidunt. Phasellus
        accumsan consequat nunc vel euismod. Suspendisse potenti. Nullam a
        libero sed ex euismod commodo nec ornare urna. Interdum et malesuada
      ...
      <div className="bg-[url(/blog-bg.png)] bg-no-repeat bg-center bg-cover sm:p-10 p-5 rounded-xl relative my-10">
        ...
        <h5 className="text-[22px] font-marcellus text-white relative">
          ...
          sem. Duis sollicitudin orci eleifend dui pharetra
        </h5>
      ...
      <p className="mb-7">
        Quisque sodales lorem eget cursus placerat. Donec posuere posuere tellus
        quis ultrices. Nunc feugiat, augue at luctus maximus, tellus erat
        sodales velit, id iaculis massa mi a libero. In nulla lectus, auctor id
        dui in, viverra egestas magna. Mauris varius mauris ac nunc dignissim
        viverra. Quisque elementum arcu laoreet lacus viverra, vitae aliquam
        risus tincidunt. Fusce congue, arcu viverra hendrerit ullamcorper,
        lectus enim aliquet lectus, quis aliquet justo arcu eu dui. Aliquam eu
        ipsum pellentesque, tristique lacus sit amet, interdum augue. Integer
        sodales finibus risus sit amet facilisis. Sed ac felis ac tellus aliquam
        pharetra. Ut semper in diam consectetur ullamcorper. Aliquam lobortis ex
        lectus, consequat elementum metus mattis non.
      </p>
      ...
      <p>
        ...
        Et tortor consequat id porta. Sapien nec sagittis aliquam malesuada
        bibendum arcu vitae elementum curabitur. Arcu non sodales neque sodales
        ut etiam sit amet. Adipiscing elit ut aliquam purus.
      </p>
    </div>
  );
};
