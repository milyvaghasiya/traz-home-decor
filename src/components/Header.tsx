...
const Header = () => {
  ...
  return (
    <div className="text-white left-0 right-0 z-50 absolute">
      <div className="flex justify-between items-center py-2 bg-gray-950 max-w-[1720px] lg:px-10 md:px-6 px-4 mx-auto">
      ...
      <div
        className={`flex justify-between items-center lg:h-20.5 h-16 max-w-[1720px] w-full lg:px-10 md:px-6 px-4 mx-auto border-b ${
          isSticky
