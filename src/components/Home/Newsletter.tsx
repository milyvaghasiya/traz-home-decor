...
const Newsletter = () => {
  return (
    <div className="bg-[url(/newsletter-bg.jpg)] bg-no-repeat bg-center bg-cover h-full relative before:absolute before:inset-0 before:h-full before:w-full before:bg-black/60">
