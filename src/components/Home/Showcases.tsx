...
const Showcases = () => {
  return (
    <div className="max-w-[1720px] lg:px-10 md:px-6 px-4 mx-auto sm:py-20 py-12.5">
      <div className="xl:mb-15 md:12.5 mb-10 grid lg:grid-cols-2 grid-cols-1 gap-y-5 items-center">
        <div>
        ...
        <p>
          ...
          gravida at. Aenean vehiculles arcu non mattis. Integer dapibus ac dui
          pretium blandit.
        </p>
      </div>
      <Image
